	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dateText.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				DatePickerDialog d = new DatePickerDialog(AbstractTransactionActivity.this,
						AlertDialog.THEME_DEVICE_DEFAULT_DARK, new OnDateSetListener(){
					@Override
		...
		timeText.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				TimePickerDialog d = new TimePickerDialog(AbstractTransactionActivity.this,
						AlertDialog.THEME_DEVICE_DEFAULT_DARK, new OnTimeSetListener(){
					@Override
