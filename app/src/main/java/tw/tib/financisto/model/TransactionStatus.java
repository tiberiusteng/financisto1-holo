...
public enum TransactionStatus implements LocalizableEnum {
	...
	PN(R.string.transaction_status_pending, R.drawable.transaction_status_pending_3, R.color.pending_transaction_color),
	...
	CL(R.string.transaction_status_cleared, R.drawable.transaction_status_cleared_3, R.color.cleared_transaction_color),
	RC(R.string.transaction_status_reconciled, R.drawable.transaction_status_reconciled_3, R.color.reconciled_transaction_color);
